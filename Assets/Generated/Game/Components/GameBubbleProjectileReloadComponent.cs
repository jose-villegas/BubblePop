...
public partial class GameContext {
    ...
    public GameEntity bubbleProjectileReloadEntity { get { return GetGroup(GameMatcher.BubbleProjectileReload).GetSingleEntity(); } }

    public bool isBubbleProjectileReload {
        get { return bubbleProjectileReloadEntity != null; }
        set {
            var entity = bubbleProjectileReloadEntity;
            if (value != (entity != null)) {
                if (value) {
                    CreateEntity().isBubbleProjectileReload = true;
                } else {
                    entity.Destroy();
                }
            }
...
public partial class GameEntity {
    ...
    static readonly BubbleProjectileReloadComponent bubbleProjectileReloadComponent = new BubbleProjectileReloadComponent();
